...
public class payElectric {  
    ...
    static void myAdd(ActionEvent e){
     Object o = e.getSource();
      ...
      {
             String prov_num = dropDown();//δεν σωστη η δηλωση, υποτιθεται πως το pay_num να παιρνει την τιμη του απο το dropDown μενου στην indexpage
             ...
             try {
                 ...
                 if (outputParameter1 == "true") {
                     ...
                     String amount = PayElectricBill.t2.getText();
                     //card();
