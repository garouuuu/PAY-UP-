...
{   
	...
	{     
		...
		frame = new OurFrame("Πληρωμή Λογαριασμού Ρεύματος", 500, 100, 400, 600);
	    
	    label1 = new OurLabel("Αριθμός Παροχής",90,5,500,100,new Font("Verdana", Font.BOLD, 20));
	
	    label2 = new OurLabel("Αριθμός Πληρωμής",102,130,180,35,new Font("Verdana", Font.BOLD, 16));
