...
public class AddBankAccount 
{
	...
	public AddBankAccount()
	{
		...
		windowLabel = new OurLabel("Συμπλήρωσε τα στοιχεία του τραπεζικού σου λογαριασμού",10,5,500,100,new Font("Verdana", Font.BOLD, 17));
		windowLabel2 = new OurLabel("σου λογαριασμού",105,28,500,100,new Font("Verdana", Font.BOLD, 17));
		...
		nextButton = new OurButton("Υποβολή",280, 530, 90, 40,new Color(0, 204, 102));
		backButton = new OurButton("Πίσω",20, 530, 90, 40,new Color(0, 128, 255));
	
		frame.add(windowLabel);
		frame.add(windowLabel2);
		frame.add(ibanText);
