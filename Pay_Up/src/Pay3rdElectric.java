...
// constructor    
 ...
 {     
    ...
    frameObj.setLayout(null);
     ...
     JLabel label1 = new JLabel("Αριθμός Παροχής");    
    frameObj.add(label1); 
    label1.setBounds(102,90,150,20);
    frameObj.setLayout(null);
    
      JTextField t1;  
    t1=new JTextField();  
    t1.setBounds(80,110, 150,30);
     frameObj.add(t1); 
    ...
    frameObj.add(label2); 
    label2.setBounds(100,140,150,20);
    frameObj.setLayout(null);
    
    JTextField t2;  
    t2=new JTextField();  
    t2.setBounds(80,160, 150,30);
     frameObj.add(t2); 
    frameObj.setVisible(true);  
    frameObj.setLayout(null);
